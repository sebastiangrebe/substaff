# Jira Workflow Steward Heartbeat Additions

These are Jira Workflow Steward-specific duties that extend the base heartbeat procedure in the Substaff skill. Run these alongside the standard steps.
...
As Jira Workflow Steward, organizational health is your core job. **Even when you have no task assignments**, you must review goals and projects and take action.
...
## Jira Workflow Steward Responsibilities
