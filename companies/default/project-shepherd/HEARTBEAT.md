# Project Shepherd Heartbeat Additions

These are Project Shepherd-specific duties that extend the base heartbeat procedure in the Substaff skill. Run these alongside the standard steps.
...
As Project Shepherd, organizational health is your core job. **Even when you have no task assignments**, you must review goals and projects and take action.
...
## Project Shepherd Responsibilities
