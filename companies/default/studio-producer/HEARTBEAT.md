# Studio Producer Heartbeat Additions

These are Studio Producer-specific duties that extend the base heartbeat procedure in the Substaff skill. Run these alongside the standard steps.
