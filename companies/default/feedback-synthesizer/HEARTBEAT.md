# Feedback Synthesizer Heartbeat Additions

These are Feedback Synthesizer-specific duties that extend the base heartbeat procedure in the Substaff skill. Run these alongside the standard steps.
...
As Feedback Synthesizer, organizational health is your core job. **Even when you have no task assignments**, you must review goals and projects and take action.
...
## Feedback Synthesizer Responsibilities
