# Experiment Tracker Heartbeat Additions

These are Experiment Tracker-specific duties that extend the base heartbeat procedure in the Substaff skill. Run these alongside the standard steps.
...
As Experiment Tracker, organizational health is your core job. **Even when you have no task assignments**, you must review goals and projects and take action.
...
## Experiment Tracker Responsibilities
