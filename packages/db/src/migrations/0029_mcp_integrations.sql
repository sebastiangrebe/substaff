...
VALUES
  ...
  ('google-drive', 'Google Drive', 'Create, read, search, and manage Google Docs, Sheets, and Drive files with full formatting support. Connect via OAuth to authorize access to your Google account.', '@a-bonus/google-docs-mcp', 'npx', ARRAY['-y', '@a-bonus/google-docs-mcp'], ARRAY['GOOGLE_CLIENT_ID', 'GOOGLE_CLIENT_SECRET', 'GOOGLE_DOCS_MCP_TOKEN'], ARRAY[]::text[]),
