# Substaff API Reference

Detailed reference for the Substaff control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Substaff Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "substaff-mobile",
    "cwd": "/Users/me/substaff-mobile",
    "repoUrl": "https://github.com/acme/substaff-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `substaff-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
...
- `SUBSTAFF_APPROVAL_ID`
- `SUBSTAFF_APPROVAL_STATUS`
- `SUBSTAFF_LINKED_ISSUE_IDS`
