# Substaff V1 Implementation Spec
...
Substaff V1 must provide a full control-plane loop for autonomous agents:
...
- Primary: PostgreSQL
- Local default: embedded PostgreSQL at `~/.substaff/instances/default/db`
- Optional local prod-like: Docker Postgres
- Optional hosted: Supabase/Postgres-compatible
- File/object storage:
  - local default: `~/.substaff/instances/default/data/storage` (`local_disk`)
...
- exactly one JSON entrypoint: `substaff.manifest.json`
