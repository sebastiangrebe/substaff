...
- installed adapter list for this Substaff instance
...
## 8. New Skill: `substaff-create-agent`

Create new skill directory:

- `skills/substaff-create-agent/SKILL.md`
...
Also update `skills/substaff/SKILL.md` to reference this skill for hiring workflows.
...
- `substaff-create-agent` skill + docs updates
