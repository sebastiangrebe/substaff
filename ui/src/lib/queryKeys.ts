export const queryKeys = {
  ...
  billing: {
    ...
    info: (vendorId: string) => ["billing", vendorId] as const,
    balance: (vendorId: string) => ["billing", "balance", vendorId] as const,
    credits: (vendorId: string) => ["billing", "credits", vendorId] as const,
  },
