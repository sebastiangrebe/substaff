...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@substaff/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@substaff/adapter-utils").TranscriptEntry[];
