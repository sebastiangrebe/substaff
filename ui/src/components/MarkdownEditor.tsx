...
import { buildProjectMentionHref, parseProjectMentionHref } from "@substaff/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("substaff-project-mention-chip");
      ...
      link.classList.add("substaff-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative substaff-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("substaff-mdxeditor", !bordered && "substaff-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "substaff-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
