...
- Running a Python script that calls the Substaff API
...
1. Substaff spawns the configured command as a child process
2. Standard Substaff environment variables are injected (`SUBSTAFF_AGENT_ID`, `SUBSTAFF_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Substaff API and perform work.
